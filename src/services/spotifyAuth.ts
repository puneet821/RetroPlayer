...
const sha256 = async (plain: string): Promise<ArrayBuffer> => {
  ...
  // window.crypto.subtle is only available in secure contexts (HTTPS).
  // Provide a JS fallback for plain HTTP localhost.
  ...
  [h0,h1,h2,h3,h4,h5,h6,h7].forEach((h,i) => v.setUint32(i*4, h, false));
  return result;
};
